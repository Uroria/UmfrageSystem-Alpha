	...
	<div class="d-flex w-100 justify-content-center align-items-center mb-2">
		...
		<div class="input-group input-group-sm col-sm-5">
          ...
          <span class="input-group-append">
            <button type="button" class="btn btn-primary btn-flat" id="search">Suche</button>
          </span>
        </div>
	</div>
	<div class=" w-100" id='ns' style="display: none"><center><b>Keine Ergebniss</b></center></div>
	<div class="row">
		<?php 
               ...
               <div class="row">
               	...
               	<div class="d-flex justify-content-center w-100 text-center">
               		<?php if(!isset($ans[$row['id']])): ?>
               			<a href="index.php?page=answer_survey&id=<?php echo $row['id'] ?>" class="btn btn-sm bg-gradient-primary"><i class="fa fa-pen-square"></i> Umfrage starten</a>
               		<?php else: ?>
               			<p class="text-primary border-top border-primary">Fertig</p>
               		<?php endif; ?>
               	</div>
               </div>
              </div>
