  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <div class="dropdown">
      ...
      <div class="dropdown-menu" style="">
        <a class="dropdown-item manage_account" href="javascript:void(0)" data-id="<?php echo $_SESSION['login_id'] ?>">Konto verwalten</a>
