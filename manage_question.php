			...
			<div class="row">
				<div class="col-sm-6 border-right">
						...
						<div class="form-group">
							<label for="" class="control-label">Frage</label>
							<textarea name="question" id="" cols="30" rows="4" class="form-control"><?php echo isset($question)? $question: '' ?></textarea>
						</div>
						<div class="form-group">
							<label for="" class="control-label">Frage Antwort Typ</label>
							<select name="type" id="type" class="custom-select custom-select-sm">
								<?php if(isset($id)): ?>
								<option value="" disabled="" selected="">Bitte hier auswählen</option>
								<?php endif; ?>
								<option value="radio_opt" <?php echo isset($type) && $type == 'radio_opt' ? 'selected':'' ?>>Einzelne Antwort-/Radiotaste</option>
								<option value="check_opt" <?php echo isset($type) && $type == 'check_opt' ? 'selected':'' ?>>Mehrfachantworten/Checkboxen</option>
								<option value="textfield_s" <?php echo isset($type) && $type == 'textfield_s' ? 'selected':'' ?>>Textfeld/ Textbereich</option>
							</select>
						</div>
				...
				<div class="col-sm-6">
					...
					<div class="preview">
						<?php if(!isset($id)): ?>
						<center><b>Wählen Sie zuerst den Typ Frage-Antwort.</b></center>
						<?php else: ?>
							...
							?>
						      	...
						      	<thead>
							      	<tr class="">
								      	...
								      	<th class="text-center">
								      		<label for="" class="control-label">Bezeichnung</label>
								      	</th>
								      	<th class="text-center"></th>
							     	</tr>
						     	</thead>
						      ...
						      <div class="col-sm-12 text-center">
						      	<button class="btn btn-sm btn-flat btn-default" type="button" onclick="<?php echo $type ?>($(this))"><i class="fa fa-plus"></i> Hinzufügen</button>
						      </div>
						      </div>
						    </div>
						</div>
...
<div id="check_opt_clone"  style="display: none">
	<div class="callout callout-info">
      ...
      <div class="row">
      <div class="col-sm-12 text-center">
      	<button class="btn btn-sm btn-flat btn-default" type="button" onclick="new_check($(this))"><i class="fa fa-plus"></i> Hinzufügen</button>
      </div>
      </div>
    </div>
</div>
<div id="radio_opt_clone" style="display: none">
	<div class="callout callout-info">
      ...
      <div class="row">
      <div class="col-sm-12 text-center">
      	<button class="btn btn-sm btn-flat btn-default" type="button" onclick="new_radio($(this))"><i class="fa fa-plus"></i> Hinzufügen</button>
      </div>
      </div>
    </div>
</div>
