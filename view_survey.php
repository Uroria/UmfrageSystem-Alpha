	...
	<div class="row">
		<div class="col-md-4">
			<div class="card card-outline card-primary">
				<div class="card-header">
					<h3 class="card-title">Umfrage Details</h3>
				</div>
				<div class="card-body p-0 py-2">
					<div class="container-fluid">
						<p>Titel: <b><?php echo $stitle ?></b></p>
						<p class="mb-0">Beschreibung:</p>
						<small><?php echo $description; ?></small>
						<p>Startet am: <b><?php echo date("M d, Y",strtotime($start_date)) ?></b></p>
						<p>Endet am: <b><?php echo date("M d, Y",strtotime($end_date)) ?></b></p>
						<p>Teilnehmer: <b><?php echo number_format($answers) ?></b></p>
		...
		<div class="col-md-8">
			<div class="card card-outline card-success">
				<div class="card-header">
					<h3 class="card-title"><b>Umfrage Fragen</b></h3>
					<div class="card-tools">
						<button class="btn btn-block btn-sm btn-default btn-flat border-success new_question" type="button"><i class="fa fa-plus"></i> Neue Frage hinzufügen</button>
					</div>
				</div>
							...
							<div class="col-md-12">	
								<span class="dropleft float-right">
									...
									<div class="dropdown-menu" style="">
								        <a class="dropdown-item edit_question text-dark" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>">Bearbeiten</a>
								        <div class="dropdown-divider"></div>
								        <a class="dropdown-item delete_question text-dark" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>">Löschen</a>
								     </div>
								</span>	
							</div>	
						</div>	
